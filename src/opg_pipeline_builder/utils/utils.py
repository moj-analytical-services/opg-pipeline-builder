...
def get_last_modified(obj: dict[Any, Any]) -> int:
    """
    ...
    Args:
        obj (dict[Any, Any]): Object is assumed to be an item found in boto3's
                    list_objects_v2 response 'Contents' list.
    Return:
...
def remove_lint_filestamp(filename: str, file_ext: str = ".snappy.parquet") -> str:
    """
...
def extract_mojap_partition(
    filepath: str, timestamp_partition_name: str = "mojap_file_land_timestamp"
) -> str:
    """
